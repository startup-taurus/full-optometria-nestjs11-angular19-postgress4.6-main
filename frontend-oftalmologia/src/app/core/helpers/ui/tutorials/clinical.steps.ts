...
export function buildHistoryLabOrderSteps(context: TutorialContext): TutorialStep[] {
  ...
  const labField = (
    ...
    popover: {
      title: t(`TUTORIALS.LABORATORY.CREATE.${key}_TITLE`),
      description: t(`TUTORIALS.LABORATORY.CREATE.${key}_TEXT`),
      side: 'right',
      align: 'start',
    },
  })
  ...
  return [
    {
      ...
      closeModal: true,
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.OPEN_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.OPEN_TEXT'),
        side: 'left',
        align: 'center',
      },
    },
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.F_CLIENT_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.F_CLIENT_TEXT'),
        side: 'bottom',
        align: 'start',
      },
    },
    labField('app-laboratory-order-step1', 'attendanceDate', 'F_ATTENDANCE'),
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.F_DELIVERY_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.F_DELIVERY_TEXT'),
        side: 'bottom',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.F_OD_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.F_OD_TEXT'),
        side: 'right',
        align: 'start',
      },
    },
    labField('app-laboratory-order-step2', 'oiSphere', 'F_OI'),
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.F_FRAME_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.F_FRAME_TEXT'),
        side: 'right',
        align: 'start',
      },
    },
    labField('app-laboratory-order-step3', 'observations', 'F_OBSERVATIONS'),
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.F_PRODUCTS_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.F_PRODUCTS_TEXT'),
        side: 'top',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        title: t('TUTORIALS.LABORATORY.CREATE.CLOSING_TITLE'),
        description: t('TUTORIALS.LABORATORY.CREATE.CLOSING_TEXT'),
        side: 'top',
        align: 'center',
      },
    },
