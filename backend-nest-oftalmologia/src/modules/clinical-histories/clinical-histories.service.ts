...
export class ClinicalHistoriesService {
  ...
  private formatResponse(clinicalHistory: ClinicalHistory) {
    return {
      ...
      previousOdVl: clinicalHistory.previousOdVl,
      previousOdVp: clinicalHistory.previousOdVp,
      previousRxOi: clinicalHistory.previousRxOi,
      previousAddOi: clinicalHistory.previousAddOi,
      previousOiVl: clinicalHistory.previousOiVl,
      previousOiVp: clinicalHistory.previousOiVp,
      previousAo: clinicalHistory.previousAo,
